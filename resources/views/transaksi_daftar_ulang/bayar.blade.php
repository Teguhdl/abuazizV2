...
@section('title', 'Bayar Sisa Daftar Ulang')
@section('breadcrumb')
<h1 class="text-xl font-semibold">Pelunasan Daftar Ulang</h1>
@endsection

@section('content')
<div class="bg-white shadow rounded-lg p-6 max-w-lg mx-auto">
    <h2 class="text-lg font-bold mb-4">Form Pelunasan Daftar Ulang</h2>

    <form action="{{ route('transaksi_daftar_ulang.bayar.store', $data->id) }}" method="POST">
        @csrf
        <div class="mb-4">
        ...
        <div class="flex justify-end">
            <a href="{{ route('transaksi_daftar_ulang.show', $data->id) }}" class="px-4 py-2 bg-gray-300 rounded mr-2">Batal</a>
